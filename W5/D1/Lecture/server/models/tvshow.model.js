...
const TvShow = new mongoose.Schema({
    title: {
        ...
        maxLength: [10, "The Title must not be more than 10 characters"]
    },
    releaseYear: {
        type: Number,
    ...
    network: {
        ...
        maxLength: [10, "The Network must not be more than 10 characters"]
    },
    creator: {
        type: String,
        required: [true, "Creator is required"],
        minLength: [3, "The Creator must be 3 or more characters"],
        maxLength: [10, "The Creator must not be more than 10 characters"]
    },
    genre: {
        type: String,
        required: [true, "Genre is required"],
        minLength: [3, "The Genre must be 3 or more characters"],
        maxLength: [10, "The Genre must not be more than 10 characters"]
    }
});
